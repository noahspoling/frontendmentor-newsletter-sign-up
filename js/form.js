...
export const form = (state) => html`
    <div id="formOuterWindow">
        ...
        <div id="formImagePane">
            <img src="/frontendmentor-newsletter-sign-up/docs/assets/illustration-sign-up-desktop.svg" class="desktop">
            <img src="/frontendmentor-newsletter-sign-up/docs/assets/illustration-sign-up-mobile.svg" class="mobile">
        </div>
    </div>
`